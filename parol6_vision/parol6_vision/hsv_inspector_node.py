...
class HSVInspector(Node):
    ...
    def __init__(self):
        ...
        # Change this to your image topic
        ...
        self.get_logger().info(f"HSV Inspector started on topic: {self.image_topic}")
    ...
    def mouse_callback(self, event, x, y, flags, param):
        ...
        if event == cv2.EVENT_MOUSEMOVE or event == cv2.EVENT_LBUTTONDOWN:
            ...
            cv2.putText(self.display, text1, (10, 30),
                        cv2.FONT_HERSHEY_SIMPLEX, 0.8, (0, 0, 255), 2)
            cv2.putText(self.display, text2, (10, 60),
                        cv2.FONT_HERSHEY_SIMPLEX, 0.8, (0, 0, 255), 2)
            cv2.putText(self.display, text3, (10, 90),
                        cv2.FONT_HERSHEY_SIMPLEX, 0.8, (0, 0, 255), 2)

            cv2.circle(self.display, (x, y), 5, (0, 255, 0), 2)
