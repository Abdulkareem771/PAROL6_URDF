#!/bin/bash
# PAROL6 - Simplified Ignition Launcher
...
echo -e "${BLUE}╔══════════════════════════════════════════════════════════════╗${NC}"
echo -e "${BLUE}║   PAROL6 - Ignition Gazebo (Simplified)                    ║${NC}"
echo -e "${BLUE}╚══════════════════════════════════════════════════════════════╝${NC}"
echo ""
...
echo -e "${GREEN}🚀 Starting PAROL6 with Ignition...${NC}"
echo ""
...
# Launch Ignition using the existing launch file
...
echo -e "${GREEN}╚══════════════════════════════════════════════════════════════╝${NC}"
echo ""
echo -e "${BLUE}After Ignition starts:${NC}"
...
# Use the existing ignition.launch.py which handles everything correctly
